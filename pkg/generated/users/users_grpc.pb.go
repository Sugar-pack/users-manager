...
func (c *usersClient) CreateUser(ctx context.Context, in *NewUser, opts ...grpc.CallOption) (*CreatedUser, error) {
	out := new(CreatedUser)
...
type UsersServer interface {
	CreateUser(context.Context, *NewUser) (*CreatedUser, error)
